...
function useForceUpdate() {
  const [, dispatch] = (0, import_react6.useReducer)((state) => !state, false);
  return dispatch;
}
...
function useGlobalListener(event, handler, capture = false) {
  const documentTarget = (0, import_react12.useCallback)(() => document, []);
...
//# sourceMappingURL=chunk-C5D36KZE.js.map
